...
public class EmailWithAttachmentLeftOver {

    public static void main(String[] args) {
        String excelFilePath = "C:\\Users\\MANOJ SHARMA\\OneDrive\\Desktop\\leftover.xlsx"; // Update with your file path
        ...
        try {
            ...
            for (Row row : sheet) {
                ...
                if (nameCell != null && emailCell != null) {
                    ...
                    sendEmailWithAttachments(senderEmail, senderPassword, recipientEmail, "association.rdcphase2@gmail.com", subject, personalizedMessage, attachmentPath1, attachmentPath2);
